...
{
	class MissileEXInfo : IProjectileInfo
	{
		...
		public IEffect Create(ProjectileArgs args) { return new MissileEX(this, args); }
	}

	class MissileEX : IEffect, ISync
	{
		readonly MissileEXInfo info;
